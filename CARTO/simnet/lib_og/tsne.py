...
def x2p(X=np.array([]), tol=1e-5, perplexity=30.0, debug=False):
    """
...
def pca(X=np.array([]), no_dims=50, debug=False):
    """
...
def tsne(X=np.array([]), no_dims=2, initial_dims=50, perplexity=30.0, debug=False):
    """
