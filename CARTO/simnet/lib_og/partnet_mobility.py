...
class PartNetMobility:
    def __init__(self: "PartNetMobilityDB", root_path: Union[str, pathlib.Path]):
        self.root_path = root_path
        self.index: List[Dict[Any, Any]] = read_compressed_json(
            self.test_dataset_path / "index.json.zst"
        )
...
PartNetMobilityDB = PartNetMobility(pathlib.Path("datasets/partnet-mobility-v0"))
...
INSTANCE_EXCLUSION_LIST = [
    ...
    # I fixed all prismatic, but left out some revolute for the sake of balance
